      ...
      >
        ...
        >
          <div className="phone-container-hero animate-float-hero reflect-hero ">
            <div className="relative  w-[280px] h-[450px] sm:h-[570px] iphone-bezel rounded-[3.5rem] p-[8px]">
              ...
              <div className="w-full h-full bg-black rounded-[3.2rem] relative overflow-hidden ring-1 ring-white/10">
                ...
                <div className="p-5 pt-14 flex flex-col h-full">
                  ...
                  {/* Request Card */}
                  <div className="glass-card-dark-hero rounded-2xl p-5 mb-2 border border-white/10 shadow-2xl">
                    ...
                    <div className="text-[11px] text-white/30 mb-0 italic font-medium">
                      Accept within 1 min
                    </div>
