...
const CinematicHero = () => {
  ...
  return (
    ...
    >
      ...
      <main
        className="relative min-h-screen z-10 pt-24 md:pt-28 lg:pt-0 px-4 md:px-10 
...
>
  <div className="phone-container-hero animate-float-hero reflect-hero">
    ...
    <div
      className="
        relative
        w-[220px] h-[450px]       /* mobile */
        sm:w-[250px] sm:h-[500px] /* small tablets */
        md:w-[260px] md:h-[540px] /* tablets */
        lg:w-[280px] lg:h-[570px] /* desktop (original) */
        iphone-bezel
        rounded-[3.5rem]
        p-[8px]
      "
    >
      ...
      <div className="w-full h-full bg-black rounded-[3.2rem] relative overflow-hidden ring-1 ring-white/10">
        ...
        {/* Status bar */}
        <div className="absolute top-0 left-0 w-full h-12 flex items-center justify-between px-6 sm:px-8 z-30">
        ...
        {/* Dynamic Island */}
        <div className="absolute top-3 left-1/2 -translate-x-1/2 w-[80px] sm:w-[90px] h-[26px] sm:h-[28px] bg-black rounded-full z-40 border border-white/5" />

        {/* Screen Content */}
        <div className="p-4 sm:p-5 pt-12 sm:pt-14 flex flex-col h-full">
          <Logo className="text-sm" />

          <div className="text-[10px] sm:text-[11px] text-white/40 mb-5 font-medium px-2 py-2">
            Accepting Requests
          </div>

          {/* Request Card */}
          <div className="glass-card-dark-hero rounded-2xl p-4 sm:p-5 mb-4 border border-white/10 shadow-2xl">
            <div className="flex justify-between items-start mb-2">
              <div className="text-[22px] sm:text-[26px] font-extrabold tracking-tighter text-white">
                5,000{" "}
                <span className="text-white/50 font-medium text-[16px] sm:text-[18px]">
                  USDT
                </span>
              </div>
            ...
            <div className="text-[12px] sm:text-[13px] text-white/40 font-medium mb-8">
              AED → USDT
            </div>

            <div className="text-[10px] sm:text-[11px] text-white/30 mb-3 italic font-medium">
              Accept within 1 min
            </div>

            <button className="w-full py-1.5 bg-white text-black text-[13px] sm:text-[14px] font-black rounded-full mb-3 shadow-[0_4px_12px_rgba(255,255,255,0.2)]">
              Accept Request
            </button>

            <div className="flex gap-2 text-[9px] text-white/50 font-medium">
              <span className="flex items-center gap-1">✓ Escrow-secured</span>
              <span className="flex items-center gap-1">✓ Visible on-chain</span>
            </div>
          </div>

          {/* Bottom security bar */}
          <div className="mt-auto mb-6 mx-2 p-3 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center gap-5">
            <div className="text-[9px] font-bold text-white/80">✓ SECURED</div>
            <div className="text-[9px] font-bold text-white/80">✓ VERIFIED</div>
          </div>

          {/* Home indicator */}
          <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-[90px] sm:w-[100px] h-[4px] bg-white/20 rounded-full" />
        </div>
      </div>
    </div>
  </div>
