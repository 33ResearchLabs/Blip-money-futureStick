    ...
    >
      ...
      >
        <motion.div
          ...
          className="hidden order-1 md:order-none md:flex items-center justify-center sm:py-2 lg:justify-start gap-2 mb-6 sm:mb-4"
        >
        ...
        <div
          className="w-full lg:w-1/3 flex justify-center order-2 sm:order-1 lg:order-1 antigravity-layer relative z-20 "
          ref={phoneLayerRef}
        >
        ...
        <div
          className="w-full lg:w-1/3 text-center lg:text-left px-4 lg:px-4 antigravity-layer order-3 md::order-2"
          ref={textLayerRef}
        >
        ...
        <div
          className="w-full px-2 sm:px-0 lg:w-1/3 flex justify-center antigravity-layer order-4 md:order-3"
