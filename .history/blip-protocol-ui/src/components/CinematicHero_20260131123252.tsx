  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="w-full lg:w-1/3 flex justify-center order-2 lg:order-1 antigravity-layer relative z-20 "
          ref={phoneLayerRef}
        >
        ...
        <div
          className="w-full lg:w-1/3 text-center lg:text-left px-4 lg:px-4 antigravity-layer order-1 lg:order-2"
          ref={textLayerRef}
        >
