...
export default function ExplorerUI() {
  ...
  return (
    <div className="w-[320px] sm:w-[420px] md:w-[500px] lg:w-[540px] rounded-2xl border border-white/[0.08] bg-[#0a0a0a] overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.3),0_0_0_1px_rgba(255,255,255,0.06)]">
      {/* Browser chrome */}
      <div className="flex items-center justify-between px-5 py-3.5 bg-[#111] border-b border-white/[0.06]">
