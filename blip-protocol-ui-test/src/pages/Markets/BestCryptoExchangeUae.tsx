          ...
          {platforms.map((platform, i) => (
            <motion.div
              ...
              className={`group relative p-6 rounded-2xl backdrop-blur-xl transition-colors duration-500 ${
                platform.highlight
                  ? "bg-white/60 dark:bg-white/[0.03] border-2 border-black/[0.15] dark:border-white/[0.12]"
            ...
            >
              {platform.highlight && (
                <span className="absolute -top-3 left-6 text-[10px] uppercase tracking-wider px-3 py-1 rounded-full bg-black dark:bg-white text-white dark:text-black font-semibold">
                  Recommended
                </span>
              )}
