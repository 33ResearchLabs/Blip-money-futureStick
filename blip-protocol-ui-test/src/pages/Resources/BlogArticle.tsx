...
function renderContentSection(section: BlogContentSection, index: number) {
  switch (section.type) {
    case "heading":
      return (
...
/* ── Related Article (Medium-style minimal row) ── */
const RelatedRow = ({
  article,
  index,
}: {
      ...
      >
        <div className="flex items-start gap-4">
          <div className="flex-1 min-w-0">
            <span className="text-[11px] font-semibold uppercase tracking-[0.12em] text-black/70 dark:text-white/30 mb-1 block">
              {article.category}
            </span>
            ...
            <div className="flex items-center gap-3 mt-2 text-xs text-black/70 dark:text-white/30">
        ...
        <header className="relative pt-32 sm:pt-40 pb-10 sm:pb-14">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            ...
            >
              ...
              {/* Category */}
              <span className="block text-[11px] font-semibold uppercase tracking-[0.15em] text-gray-400 dark:text-white/35 mb-5">
                {article.category}
              </span>
              ...
              <div className="flex items-center gap-4 pb-10 border-b border-gray-100 dark:border-white/[0.06]">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 text-[13px] text-gray-700 dark:text-white/40">
                    <span>{formatDate(article.date)}</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                >
                  ...
                  <span className="block text-xs text-gray-700 dark:text-white/30 mt-1">
                    {link.desc}
                  </span>
                </Link>
              ))}
