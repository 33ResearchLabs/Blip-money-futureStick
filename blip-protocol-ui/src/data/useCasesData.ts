...
export const useCases: UseCase[] = [
  {
    ...
    cta: { text: "Start Receiving Payments", link: "https://app.blip.money/waitlist/user" },
    seo: {
  ...
  },
  {
    ...
    cta: { text: "Start Trading on Blip", link: "https://app.blip.money/waitlist/user" },
    seo: {
  ...
  },
  {
    ...
    cta: { text: "Send Money Now", link: "https://app.blip.money/waitlist/user" },
    seo: {
