  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-zinc-900 border border-zinc-800 rounded-lg max-w-lg w-full max-h-[90vh] overflow-hidden">
        ...
        {/* Total Points */}
        <div className="p-6 border-b border-zinc-800 bg-gradient-to-r from-[#ffffff]/5 to-transparent">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-500">
                Total Accumulated Points
              </span>
              <div className="text-4xl font-black text-[#ffffff] tracking-tighter mt-1">
