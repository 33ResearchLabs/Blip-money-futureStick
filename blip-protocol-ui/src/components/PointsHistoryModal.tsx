  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-zinc-900 border border-zinc-800 rounded-lg max-w-lg w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-zinc-800">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#FF9F1A]/20 flex items-center justify-center">
              <Coins className="w-5 h-5 text-[#FF9F1A]" />
            </div>
            <div>
        ...
        {/* Total Points */}
        <div className="p-6 border-b border-zinc-800 bg-gradient-to-r from-[#FF9F1A]/5 to-transparent">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-500">
                Total Accumulated Points
              </span>
              <div className="text-4xl font-black text-[#FF9F1A] tracking-tighter mt-1">
            ...
            <div className="space-y-3">
              {history.map((log, index) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <span className="text-lg font-bold text-[#FF9F1A]">
                      +{log.points}
                    </span>
