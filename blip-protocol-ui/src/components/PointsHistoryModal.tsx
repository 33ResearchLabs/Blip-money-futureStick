      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-black/[0.06] dark:border-white/[0.06]">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-black/[0.04] dark:bg-white/5 border border-black/[0.08] dark:border-white/[0.06] flex items-center justify-center shrink-0">
