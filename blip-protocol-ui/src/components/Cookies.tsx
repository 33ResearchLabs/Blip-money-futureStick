    ...
    <div className="min-h-screen bg-black text-white px-6 py-24">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-300 mb-8 leading-relaxed">
          This Cookie Policy explains how Blip.money ("we," "us," or "our") uses
          cookies and similar technologies on our website. This policy is
          designed to be transparent about our practices, in line with our core
          principle of user privacy and anonymity.
        </p>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-400 space-y-2 mb-4">
            ...
            <li>
              <span className="text-white">Personalization:</span> We do not use
              cookies to store personal preferences or identify you on return
              visits.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside text-gray-400 space-y-2">
            ...
            <li>
              <span className="text-white">Functionality Cookies:</span> We may
              use cookies to remember settings that improve your experience,
              such as language preference, but these do not contain personal
              information.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-400 mb-4 leading-relaxed">
            ...
            allow you to manage your cookie preferences through their settings.
            You can typically:
          </p>
          ...
          <p className="text-gray-400 leading-relaxed">
            Please note that if you choose to block all cookies, our website may
            not function as intended, as you would be disabling strictly
