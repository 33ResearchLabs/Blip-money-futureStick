...
function TradingBuySellToggle() {
  ...
  return (
    <div className="flex items-center bg-neutral-800 rounded-full p-0.5 relative">
      ...
      />
      <span
        className={`relative z-10 text-[9px] font-semibold px-3 py-0.5 ${isBuy ? "text-white" : "text-white/50"}`}
      >
        Buy
      </span>
      <span
  ...
  return (
    ...
    >
      <div className="pt-[46px] px-4 pb-3">
        <div className="flex items-center justify-between mb-4">
          <span className="text-[9px] text-white/40 font-medium">← Back</span>
        ...
        <motion.div
          ...
          className="text-center mb-4"
        >
          <p className="text-[20px] font-bold text-white">5,000.00 USDT</p>
        ...
        <motion.div
          ...
          className="bg-neutral-900 rounded-xl p-3 border border-white/[0.04] mb-3"
        >
          {[
            ...
            <div
              key={item.label}
              className={`flex items-center justify-between py-1.5 ${i < 4 ? "border-b border-white/[0.04]" : ""}`}
            >
      ...
      >
        <p className="text-[8px] text-white/40 uppercase tracking-wider mb-2.5">
          Status Timeline
        </p>
        <div className="relative">
              ...
              >
                <div className="flex flex-col items-center">
                  <motion.div
                    ...
                    transition={{ duration: 0.4 }}
                    className="w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0 border border-white/[0.06]"
                  >
                    {isActive && (
                      <motion.div
                        initial={{ scale: 0 }}
                  ...
                  {!isLast && (
                    <motion.div
                      animate={{
                        backgroundColor:
                          i < activeStep ? "#10b981" : "rgba(255,255,255,0.06)",
                      }}
                      transition={{ duration: 0.4 }}
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-[-15%] left-[-15%] w-[65%] h-[65%] bg-[#ff6b35]/25 dark:bg-[#ff6b35]/12 rounded-full blur-[160px]"
        />
                ...
                {stage === "trading" && (
                  ...
                  >
                    ...
                    <div className="pt-[48px] px-4 pb-14 h-full overflow-hidden">
                      ...
                      >
                        <div className="flex items-center gap-1.5">
                          <div className="w-6 h-6 rounded-full bg-neutral-800 flex items-center justify-center text-[8px] font-bold text-white/60">
                            G
                          </div>
                          <div>
                      ...
                      >
                        ...
                        <div className="mb-3">
                          <span className="text-[8px] text-white/40 block mb-1.5">
                            Matching priority
                          </span>
                    ...
                    <motion.div
                      ...
                      className="absolute bottom-3 left-3 right-3 z-10"
                    >
                      <div className="bg-[#111]/90 backdrop-blur-xl rounded-2xl px-4 py-2.5 flex items-center justify-around border border-white/[0.06]">
                        {[
