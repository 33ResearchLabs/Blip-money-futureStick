...
const userCases = [
  { icon: Globe,       label: "Pay globally",      desc: "Send to anyone, anywhere — instantly." },
  { icon: ShoppingBag, label: "Pay anywhere",      desc: "Tap to pay at stores and across borders." },
  { icon: Gift,        label: "Earn rewards",       desc: "Cashback on every transaction." },
  { icon: Eye,         label: "Private by default", desc: "Your keys, your funds, your data." },
];

const merchantCases = [
  { icon: Store,        label: "Global payments",  desc: "Receive from any corridor without banks." },
  { icon: Zap,          label: "Instant liquidity", desc: "On-demand liquidity for every trade." },
  { icon: ShieldOff,    label: "No chargebacks",   desc: "Escrow-settled trades are final." },
  { icon: TrendingDown, label: "Lower fees",        desc: "0.1% vs 3–7% on traditional rails." },
];

/* ── Live earn feed ── */
const ALL_TXNS = [
  { emoji: "☕", label: "The Coffee Co.",  amount: 0.50  },
  { emoji: "🛒", label: "Dubai Mall",      amount: 2.40  },
  { emoji: "✈️", label: "Emirates Air",   amount: 12.80 },
  { emoji: "🏨", label: "Armani Hotel",   amount: 28.60 },
...
const UseCasesSection = () => {
  ...
  return (
    <section
      className="relative py-24 md:py-32 overflow-hidden bg-[#FAF8F5] dark:bg-black/70"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <motion.p
          ...
          className="text-base md:text-lg text-black/50 dark:text-white/40 max-w-lg text-center mx-auto leading-relaxed mb-12 font-medium"
        >
