    ...
    <div className="w-full max-w-[400px]">
      ...
      <div className="mb-6">
        ...
        >
          ...
          <span className="text-sm font-medium text-black/20 dark:text-white/20 ml-2">
            BLIP
          </span>
        </motion.div>
      </div>
          ...
          {rows.map((tx, i) => (
            <motion.div
              ...
              style={{
                ...
                border:
                  i === 0 && flash
                    ? "1px solid rgba(61,220,132,0.12)"
                    : "1px solid transparent",
                transition: "background 0.3s, border 0.3s",
              }}
            >
              <span className="text-lg">{tx.emoji}</span>
              <span className="flex-1 text-sm text-black/50 dark:text-white/50">
                {tx.label}
              </span>
              <span className="text-sm font-bold font-mono text-[#3ddc84]">
                +{tx.amount.toFixed(2)}
              </span>
            </motion.div>
          ))}
...
function LiveSendVisual({ isDark }: { isDark: boolean }) {
  ...
  return (
    <div
      ref={ref}
      className="w-full max-w-[380px] mx-auto rounded-3xl overflow-hidden"
      style={{
    ...
    >
      <div className="px-6 pt-7 pb-5">
        <div className="flex items-center justify-between mb-5">
          <div className="text-[10px] font-semibold uppercase tracking-widest text-black/25 dark:text-white/25">
            Send money
          </div>
          <motion.div
          ...
          >
            <div
              ...
              style={{
                background: phase === "done" ? "#3ddc84" : "rgba(0,0,0,0.15)",
              }}
            />
            <span
              className="text-[9px] font-semibold"
              style={{
                color: phase === "done" ? "#3ddc84" : "rgba(0,0,0,0.25)",
              }}
            >
              {phase === "done"
                ? "Settled"
        ...
        <motion.div
          ...
          animate={{ opacity: phase === "typing" ? [0.5, 1, 0.5] : 1 }}
          transition={{
            duration: 1,
        ...
        <div className="text-sm text-black/30 dark:text-white/30 mb-5">
          USDT → AED
        </div>
        ...
        >
          <div className="w-10 h-10 rounded-full bg-black/5 dark:bg-white/10 flex items-center justify-center text-sm font-bold text-black/40 dark:text-white/40">
            A
          </div>
          ...
          <motion.div
            animate={{ scale: phase === "done" ? [1, 1.2, 1] : 1 }}
            className="text-right"
          >
            <div
              className="font-mono text-sm font-bold"
              style={{
                color: phase === "done" ? "#3ddc84" : "rgba(0,0,0,0.3)",
              }}
            >
              {phase === "done" ? "~42s" : "—"}
            </div>
            <div className="text-[9px] text-black/20 dark:text-white/20">
              settle time
            </div>
          </motion.div>
        </div>
            ...
            return (
              <div key={s} className="flex-1">
                ...
                <span
                  ...
                  style={{ color: stepDone ? "#3ddc84" : "rgba(0,0,0,0.2)" }}
                >
                  {s}
                </span>
              </div>
      ...
      <div className="px-6 pt-7 pb-5">
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-1.5">
            ...
            />
            <span className="text-[9px] font-semibold text-black/25 dark:text-white/25">
              Live
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          ...
          >
            <div className="text-[9px] font-semibold uppercase tracking-wider text-black/25 dark:text-white/25">
              Total earned
            </div>
            <motion.div
              key={Math.floor(totalEarned)}
              initial={{ y: -3, opacity: 0.6 }}
              animate={{ y: 0, opacity: 1 }}
              className="text-xl font-bold font-mono text-[#3ddc84] tracking-tight"
            >
          ...
          >
            ...
            <motion.div
              ...
              initial={{ y: -3, opacity: 0.6 }}
              animate={{ y: 0, opacity: 1 }}
              className="text-xl font-bold font-mono text-black/80 dark:text-white tracking-tight"
            >
              {orders}
            </motion.div>
          </div>
        ...
        <div className="text-[9px] font-semibold uppercase tracking-wider text-black/25 dark:text-white/25 mb-2">
          Settled trades — your earnings
        </div>
        <AnimatePresence mode="popLayout">
          {trades.map((t, i) => (
            <motion.div
              key={`${t.pair}-${t.amount}-${i}`}
            ...
            >
              <div>
                ...
                <span className="text-[10px] text-black/25 dark:text-white/25 ml-2">
                  {t.amount}
                </span>
              </div>
              <div className="flex items-center gap-3">
                ...
                <motion.span
                  initial={i === 0 ? { scale: 1.2 } : false}
                  animate={{ scale: 1 }}
                  className="text-xs font-bold font-mono text-[#3ddc84]"
                >
                  {t.earned}
                </motion.span>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, rgba(29,29,31,0.95) 40%, rgba(29,29,31,0.4) 100%)",
              }}
            />
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-8 p-8 md:p-12">
              ...
              <div className="flex-1 min-w-0">
                ...
                >
                  <EditableText
                    id="home.usecases.users.eyebrow"
                    default="For users"
                  />
                </span>
                <h3
                ...
                >
                  <EditableText
                    id="home.usecases.users.title.line1"
                    default="Send USDT."
                    as="span"
                  />
                  <br />
                  <EditableText
                    id="home.usecases.users.title.line2"
                    default="Get cash delivered."
                    as="span"
                  />
                </h3>
                <p
                ...
                >
                  <EditableText
                    id="home.usecases.users.desc"
                    default="Cross-border remittance in under 60 seconds. No banks. No forms. Recipient gets local currency instantly."
                    multiline
                  />
                </p>
                ...
                <div className="flex items-center gap-4 mb-6">
                  {[
                    ...
                    <div key={s.lbl} className="flex items-center">
                      {i > 0 && <div className="w-px h-10 bg-white/15 mx-2" />}
            ...
            <div className="flex md:grid md:grid-cols-2 gap-4 overflow-x-auto md:overflow-visible snap-x snap-mandatory md:snap-none [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(29,29,31,0.95) 50%, rgba(29,29,31,0.6) 100%)",
                  }}
                />

                <div
                  className="relative z-10 p-7 flex flex-col h-full justify-end"
                  style={{ minHeight: 380 }}
                >
                  <span
                    style={{
                  ...
                  >
                    <EditableText
                      id="home.usecases.merchants.eyebrow"
                  ...
                  >
                    <EditableText
                      id="home.usecases.merchants.title.line1"
                      default="Accept crypto."
                      as="span"
                    />
                    <br />
                    <EditableText
                      id="home.usecases.merchants.title.line2"
                      default="Earn on every trade."
                      as="span"
                    />
                  </h3>
                  <p
                  ...
                  >
                    <EditableText
                      id="home.usecases.merchants.desc"
                      default="Instant settlement. Zero chargebacks. Margin on every order."
                      multiline
                    />
                  </p>
                  <div className="flex items-center gap-4 mb-5">
                    <div>
                      <div className="font-mono text-lg font-bold text-[#3ddc84]">
                        $1,247
                      </div>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: isDark
                      ? "linear-gradient(to top, rgba(17,17,17,0.95) 50%, rgba(17,17,17,0.7) 100%)"
                      : "linear-gradient(to top, rgba(255,255,255,0.95) 50%, rgba(255,255,255,0.8) 100%)",
                  }}
                />
                ...
                >
                  ...
                  >
                    <EditableText
                      id="home.usecases.lps.eyebrow"
                      default="For liquidity providers"
                    />
                  </span>
                  <h3
                    style={{
                  ...
                  >
                    <EditableText
                      id="home.usecases.lps.title.line1"
                      default="Deploy capital."
                      as="span"
                    />
                    <br />
                    <EditableText
                      id="home.usecases.lps.title.line2"
                      default="Capture spread."
                      as="span"
                    />
                  </h3>
                  <p
                  ...
                  >
                    <EditableText
                      id="home.usecases.lps.desc"
                      default="Fund settlement routes. Earn infrastructure yield. Full control."
                      multiline
                    />
                  </p>
                  <div className="flex items-center gap-4 mb-5">
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        <div>
          <div className="text-[8px] font-semibold uppercase tracking-wider text-white/25 mb-1">
            Today's earnings
          </div>
          <motion.div
            ...
            initial={{ y: -3, opacity: 0.6 }}
            animate={{ y: 0, opacity: 1 }}
            className="font-mono text-xl font-bold text-[#3ddc84]"
          >
...
function LiveLPMini({ isDark }: { isDark: boolean }) {
  ...
  useEffect(() => {
    const id = setInterval(
      () => setDeployed((v) => v + Math.floor(Math.random() * 200 + 50)),
      3500,
    );
    return () => clearInterval(id);
  }, []);
    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-right">
          ...
          <div className="font-mono text-xl font-bold text-[#3ddc84]">
            11.2%
          </div>
        </div>
      </div>
      {routes.map((r, i) => (
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-bold font-mono text-[#3ddc84]">
              {r.apy}
            </span>
          </div>
        </div>
