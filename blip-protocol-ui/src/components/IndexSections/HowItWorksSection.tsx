    ...
    <div className="flex-1 flex flex-col gap-2.5 px-4 pb-3">
      ...
      <div className="flex justify-between items-start pt-1">
        <div>
          ...
          <p
            style={{
              fontSize: 9,
              color: isDark ? "rgba(255,255,255,0.35)" : "rgba(0,0,0,0.60)",
              fontWeight: 500,
              marginTop: 3,
            }}
          >
        ...
        >
          ...
          <span
            style={{
              fontSize: 9,
              fontWeight: 600,
              color: isDark ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.60)",
              letterSpacing: "0.16em",
              textTransform: "uppercase",
            }}
          >
        ...
        >
          <ArrowRight
            ...
            style={{
              ...
              color: isDark ? "rgba(255,255,255,0.45)" : "rgba(0,0,0,0.60)",
            }}
          />
        </div>
      </div>
      ...
      <div
        style={{
          ...
          fontSize: 9,
          fontWeight: 700,
          color: isDark ? "rgba(255,255,255,0.45)" : "rgba(0,0,0,0.70)",
          letterSpacing: "0.18em",
          textTransform: "uppercase",
        }}
      >
  ...
  >
    ...
    <div className="flex flex-col items-center justify-center flex-1 w-full px-4 pb-3">
      ...
      <p
        style={{
          fontSize: 8,
          color: isDark ? "rgba(255,255,255,0.25)" : "rgba(0,0,0,0.70)",
          fontWeight: 600,
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span
                style={{
                  fontSize: 8,
                  fontWeight: 600,
                  color: isDark ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.70)",
                  letterSpacing: "0.14em",
                  textTransform: "uppercase",
                }}
              >
