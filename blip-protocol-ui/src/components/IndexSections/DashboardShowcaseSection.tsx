...
import { HoverTooltip, MicroBounce, CursorFollower, GradientText, KineticText } from "@/components/effects/SubtleEffects";
...
const floatingCards = [
  {
    ...
    footerColor: "#ffffff",
    tooltip: "Send money to family instantly with low fees",
  },
  {
    label: "CRYPTO",
    type: "default",
    ...
    footerBg: "rgba(255,255,255,0.2)",
    footerColor: "#ffffff",
    tooltip: "Buy and sell Bitcoin with local merchants",
  },
  {
    label: "ONCHAIN",
    type: "onchain",
    ...
    textColor: "#ffffff",
    tooltip: "All transactions settled instantly on-chain",
  },
  {
    label: "BILLS",
    type: "default",
    ...
    footerBg: "rgba(255,255,255,0.2)",
    footerColor: "#ffffff",
    tooltip: "Pay bills directly with cryptocurrency",
  },
  {
    label: "MERCHANT",
    type: "default",
    ...
    footerBg: "#6366f1",
    footerColor: "#ffffff",
    tooltip: "Merchants compete for best exchange rates",
  },
];
      ...
      <div className="sticky top-0 h-screen overflow-hidden" style={{ transform: "translate3d(0, 0, 0)" }}>
        ...
        <div className="absolute inset-0 z-20 hidden sm:flex items-center justify-center pointer-events-none">
          {floatingCards.map((card, index) => (
            <HoverTooltip
              key={card.label}
              content={card.tooltip || card.label}
              delay={0.5}
            >
              <motion.div
                className={`absolute ${card.size} pointer-events-auto`}
                style={{
              ...
              {/* Custom UI Card with cursor follower */}
              <CursorFollower>
                <div
                  className="relative w-full h-full rounded-2xl overflow-hidden shadow-[0_12px_48px_-8px_rgba(0,0,0,0.4)] hover:shadow-[0_20px_60px_-12px_rgba(0,0,0,0.5)] transition-shadow duration-300 group"
                  style={{
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center">
          ...
          >
            <h2 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-semibold tracking-tight leading-[0.95] text-black dark:text-white">
              <KineticText>Send money to</KineticText>
              <br />
              <KineticText>anyone, </KineticText>
              <GradientText className="font-bold" animated>
                anywhere.
              </GradientText>
            </h2>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center gap-6 rounded-full border border-black/10 dark:border-white/[0.08] px-10 py-6 backdrop-blur-sm">
              ...
              <MicroBounce>
                <Link
                  to="/send"
                  className="group inline-flex items-center gap-2 px-6 py-3 rounded-full bg-black text-white dark:bg-white dark:text-black text-sm font-semibold hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-all hover:shadow-[0_0_30px_rgba(0,0,0,0.3)] dark:hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]"
                >
                  Get started
