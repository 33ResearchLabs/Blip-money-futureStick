          ...
          <div className="flex items-center justify-between px-5 pt-3 pb-1">
            ...
            <div className="flex items-center gap-[3px]">
              ...
              <svg width="10" height="8" viewBox="0 0 10 8" fill="none">
                <path
                  d="M5 7.5a0.5 0.5 0 1 0 0-1 0.5 0.5 0 0 0 0 1z"
                  fill="white"
                  opacity="0.8"
                />
                <path
                  d="M3 5.5a3 3 0 0 1 4 0"
                  stroke="white"
                  strokeWidth="1"
                  opacity="0.8"
                  strokeLinecap="round"
          ...
          <div className="flex-1 flex flex-col overflow-hidden px-3.5">
            ...
            <div className="flex gap-1.5 mb-3">
              ...
              >
                ...
                <div className="text-[8px] font-semibold text-white/40">
                  Sell USDT
                </div>
            ...
            <div className="text-center mb-1">
              <div
                className="text-[13px] font-bold text-white/50 tracking-tight"
                style={{ direction: "ltr" }}
              >
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[5.5px] text-white/25">
                  TRADER GETS{" "}
                  <span className="text-[#00e599]/60 font-semibold">1.00%</span>
                </span>
              </div>
            </div>
            ...
            <div className="mb-2">
              ...
              <div className="flex gap-1.5">
                ...
                >
                  ...
                  <div>
                    <div className="text-[7px] text-white/80 font-semibold">
                      Bank Transfer
                    </div>
                    <div className="text-[5px] text-white/25 uppercase tracking-wider">
                      Wire / IBAN
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    <div className="text-[7px] text-white/40 font-semibold">
                      Cash
                    </div>
                    <div className="text-[5px] text-white/15 uppercase tracking-wider">
                      USDT in person
                    </div>
                  </div>
                </div>
                ...
                {[
                  ...
                  >
                    <span
                      ...
                      style={{ opacity: p.active ? 0.8 : 0.3 }}
                    >
                      {p.icon}
                    </span>
                    <span
