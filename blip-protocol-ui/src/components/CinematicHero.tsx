...
const CinematicHero = () => {
  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 pt-28 md:pt-32 pb-16 md:pb-32 px-4 md:px-10 max-w-[1600px] mx-auto flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-6">
