...
const STATIC_RATE = { inr: 8100000, usd: 97200, inr_24h_change: 1.2 };
...
const POPULAR_AMOUNTS = [
  { crypto: 1, label: "1 BTC to INR" },
  { crypto: 0.5, label: "0.5 BTC to INR" },
  { crypto: 0.1, label: "0.1 BTC to INR" },
  { crypto: 0.01, label: "0.01 BTC to INR" },
  { crypto: 0.005, label: "0.005 BTC to INR" },
  { crypto: 0.001, label: "0.001 BTC to INR" },
];
...
const HOW_TO_STEPS = [
  ...
  },
  {
    ...
    description:
      "Select Bitcoin (BTC) and enter the amount you want to convert. You will see the live BTC/INR rate and the exact INR amount you will receive after fees.",
  },
  {
    step: 3,
  ...
  },
  {
    ...
    title: "Receive INR",
    description:
      "The merchant sends INR to your Indian bank account via UPI or IMPS. Once confirmed, the escrow releases automatically. Typical settlement: under 15 minutes.",
  },
];
...
const FAQ_DATA = [
  {
    ...
    a: "The current Bitcoin price in INR is displayed in our live converter at the top of this page, updated every 30 seconds from global market data. Bitcoin's price against the Indian Rupee fluctuates 24/7 based on global supply and demand. Blip sources rates from multiple liquidity providers to ensure you receive a competitive BTC/INR rate.",
  },
  {
    q: "How to sell Bitcoin for INR in India?",
    a: "With Blip, you can sell Bitcoin for INR in India in under 15 minutes. Connect your wallet, enter the BTC amount, and Blip's matching engine pairs you with a verified merchant. Your BTC value is held in on-chain escrow until the merchant confirms the INR bank transfer via UPI or IMPS. There's no need to use a centralized exchange like WazirX or CoinDCX.",
  },
  {
    q: "Is Bitcoin legal in India?",
    a: "Yes. Bitcoin and other cryptocurrencies are legal in India. The Supreme Court of India struck down the RBI banking ban in 2020, restoring crypto trading. While the Indian government has not passed a dedicated crypto regulation bill, crypto assets are taxed under the Income Tax Act. A 30% tax applies on gains from virtual digital assets, and a 1% TDS is deducted at source on all crypto transactions above ₹10,000.",
  },
  {
    q: "What's the best way to convert BTC to INR?",
    a: "The best way to convert BTC to INR depends on your priorities. For speed and security, Blip offers non-custodial escrow-protected settlement in under 15 minutes. Unlike centralized exchanges like WazirX, CoinDCX, or ZebPay where your funds are held in custodial wallets, Blip keeps you in control of your keys until the trade executes. For large amounts, Blip's merchant matching engine finds high-liquidity counterparties to minimize slippage.",
  },
  {
    q: "How long does BTC to INR conversion take?",
    a: "On Blip, most BTC to INR conversions complete within 5-15 minutes. The escrow lock is near-instant on Solana (sub-second finality). The total time depends on how quickly the matched merchant confirms the INR bank transfer. The average settlement time across all Blip trades is under 10 minutes.",
  },
  {
    q: "What fees apply to BTC to INR conversion?",
    a: "Blip charges a transparent 0.5% protocol fee, displayed before you confirm any trade. Solana network fees are under $0.01 per transaction. There are no hidden fees, exchange rate markups, or withdrawal charges. During the beta phase, early adopters benefit from reduced fees. This is significantly lower than most Indian exchanges (1-2%) and P2P platforms. Note: a 1% TDS applies on crypto transactions as per Indian tax law.",
  },
  {
    q: "Can I convert small amounts of BTC to INR?",
    a: "Yes. Blip supports BTC to INR conversions starting from approximately ₹500 equivalent. Whether you want to convert 0.001 BTC or 10 BTC, the process is the same. The live converter at the top of this page lets you check exact INR amounts for any BTC quantity before you initiate a trade.",
  },
  {
    q: "How does Blip's BTC to INR rate compare to other exchanges?",
    a: "Blip's BTC/INR rates are sourced from global market data and typically match or beat rates on Indian exchanges like WazirX, CoinDCX, and ZebPay. Because Blip connects you directly with merchants in a peer-to-peer model (without a centralized order book), there are no hidden spread markups. The rate you see in the converter is the rate you get, minus the transparent 0.5% protocol fee.",
  },
];
...
function buildSchemas(rate: RateData) {
  ...
  const financialServiceSchema = {
    ...
    offers: {
      "@type": "Offer",
      description: "BTC to INR conversion",
  ...
  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to Convert Bitcoin to INR",
    description:
      "Step-by-step guide to convert Bitcoin to Indian Rupees using Blip Money's escrow-protected settlement protocol.",
    totalTime: "PT15M",
...
export default function BtcToInr() {
    ...
    <>
      ...
      <div className="min-h-screen bg-[#FAF8F5] dark:bg-transparent">
          ...
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-black/50 dark:text-white/40 max-w-xl leading-relaxed mb-10">
                Convert BTC to Indian Rupees instantly. Live BTC/INR rate,
              ...
              <div className="bg-white/80 dark:bg-white/[0.04] backdrop-blur-xl border border-black/[0.08] dark:border-white/[0.06] rounded-2xl p-6 sm:p-8 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.08)] dark:shadow-none">
                ...
                >
                  <span className="relative z-10">Convert BTC to INR</span>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-black/40 dark:text-white/35 mt-1">
                  Historical Bitcoin to INR exchange rate
                </p>
              </div>
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            ...
            <div className="bg-white/60 dark:bg-white/[0.03] border border-black/[0.06] dark:border-white/[0.06] rounded-2xl p-6 sm:p-8">
              ...
              <p className="text-[15px] text-black/50 dark:text-white/40 leading-relaxed mb-4">
                In India, Bitcoin is one of the most widely held
                cryptocurrencies, with growing adoption for both investment and
                remittances. While the RBI initially imposed a banking ban on
                crypto in 2018, the Supreme Court overturned it in 2020, and
                Indian exchanges like WazirX, CoinDCX, and ZebPay have seen
                significant growth. India is now one of the largest crypto
                markets in the world by user base.
              </p>
              <p className="text-[15px] text-black/50 dark:text-white/40 leading-relaxed">
                Converting Bitcoin to INR allows holders to realize gains, fund
                local expenses, or diversify into fiat currency. Blip provides a
                fast, non-custodial way to settle BTC to INR through
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            ...
            <p className="text-black/40 dark:text-white/35 mb-8">
              The live Bitcoin to INR exchange rate and key market data.
            </p>
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-black dark:text-white mb-2">
              Bitcoin to INR Conversion Table
            </h2>
            <p className="text-black/40 dark:text-white/35 mb-8">
              Quick reference for common BTC to INR amounts at the current live
              rate.
            </p>
                  ...
                  {CONVERSION_TABLE.map((row) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right font-semibold text-black dark:text-white tabular-nums">
                        ₹
                        {(row.amount * rate.inr).toLocaleString("en-IN", {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                        })}
                      </td>
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-black dark:text-white mb-8">
              Popular BTC to INR Conversions
            </h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {POPULAR_AMOUNTS.map((item) => (
                <Link
                  key={item.crypto}
                  to={`/btc-to-inr?amount=${item.crypto}`}
                ...
                >
                  ...
                  <span className="block text-lg font-bold text-black dark:text-white mt-1 tabular-nums">
                    ₹
                    {(item.crypto * rate.inr).toLocaleString("en-IN", {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </span>
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            ...
            <p className="text-black/40 dark:text-white/35 mb-10">
              Convert BTC to Indian Rupees in 4 simple steps using Blip's
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-black dark:text-white mb-10">
              Why Convert Bitcoin to INR on Blip
            </h2>
              ...
              {[
                {
                  ...
                  desc: "From trade initiation to INR in your bank. No waiting for exchange withdrawals or confirmations.",
                },
                {
                  icon: Shield,
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            ...
            <p className="text-black/40 dark:text-white/35 mb-8 text-center">
              Everything you need to know about converting Bitcoin to Indian
              Rupees.
            </p>
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-black dark:text-white mb-4">
              Ready to Convert Bitcoin to INR?
            </h2>
            <p className="text-lg text-black/40 dark:text-white/35 max-w-lg mx-auto mb-8">
              Join thousands converting BTC to INR on the fastest, most secure
              settlement protocol in India.
            </p>
            {/* <Link
              to="/waitlist"
              onClick={() => sounds.click()}
