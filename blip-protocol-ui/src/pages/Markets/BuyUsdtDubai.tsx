    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <CTAButton to="https://app.blip.money/waitlist/user" className="w-[220px] h-[48px]">Start Buying USDT</CTAButton>
        </motion.div>
      </div>
    </section>
  );
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <CTAButton to="https://app.blip.money/waitlist/user" > Start Buying USDT</CTAButton>
