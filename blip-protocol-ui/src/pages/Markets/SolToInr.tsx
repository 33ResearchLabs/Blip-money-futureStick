...
const POPULAR_AMOUNTS = [
  { crypto: 100, label: "100 SOL to INR" },
  { crypto: 50, label: "50 SOL to INR" },
  { crypto: 10, label: "10 SOL to INR" },
  { crypto: 5, label: "5 SOL to INR" },
  { crypto: 1, label: "1 SOL to INR" },
  { crypto: 0.5, label: "0.5 SOL to INR" },
];
...
const HOW_TO_STEPS = [
  ...
  },
  {
    ...
    description:
      "Select Solana (SOL) and enter the amount you want to convert. The live SOL/INR rate and exact Rupee amount you will receive are displayed instantly — no bridging required.",
  },
  {
    step: 3,
  ...
  },
  {
    ...
    title: "Receive INR",
    description:
      "The verified merchant sends INR to your Indian bank account via UPI or IMPS. Once confirmed, the escrow releases your SOL to the merchant automatically. Typical settlement: 5-10 minutes.",
  },
];
...
const FAQ_DATA = [
  {
    q: "What is the current Solana price in INR?",
    a: "The current Solana price in INR is displayed in our live converter at the top of this page, updated every 30 seconds from global market data. SOL/INR fluctuates continuously based on market dynamics. Because Blip is built natively on Solana, you get the most direct and competitive SOL/INR rate available.",
  },
  {
    q: "How to sell Solana for INR in India?",
    a: "Blip is the fastest way to sell SOL for INR in India. Connect your Solana wallet, enter the amount, and Blip matches you with a verified local merchant. Your SOL is locked in on-chain escrow (sub-second on Solana) until the merchant confirms the INR transfer via UPI or IMPS. Since Blip runs natively on Solana, there is no bridging delay — the entire process typically completes in 5-10 minutes.",
  },
  {
    q: "Is Solana legal in India?",
    a: "Yes. Solana and other cryptocurrencies are legal to buy, sell, and hold in India. The Indian government taxes crypto gains at a flat 30% under Section 115BBH of the Income Tax Act, with an additional 1% TDS on transfers above ₹10,000 (or ₹50,000 for specified persons) under Section 194S. Crypto is regulated but not banned — RBI has clarified that banks cannot refuse services to crypto users following the 2020 Supreme Court ruling.",
  },
  {
    q: "Why is SOL to INR faster on Blip than other platforms?",
    a: "Blip is built natively on the Solana blockchain, which means SOL transactions do not require any cross-chain bridging. Solana's 400ms block time and sub-second finality make escrow locking near-instant. Combined with Blip's merchant matching engine and UPI-based INR settlement, most SOL to INR settlements complete in 5-10 minutes — faster than any centralized exchange withdrawal process.",
  },
  {
    q: "What fees apply to SOL to INR conversion?",
    a: "Blip charges a transparent 0.5% protocol fee displayed before you confirm any trade. Solana network fees are under $0.01 per transaction — the lowest of any major blockchain. There are no hidden fees, exchange rate markups, or withdrawal charges. Note that Indian tax law requires 1% TDS on crypto transfers, which is deducted separately. SOL conversions are the most cost-effective on Blip due to Solana's native integration.",
  },
  {
  ...
  {
    q: "What is the minimum SOL to INR conversion amount?",
    a: "The minimum SOL to INR conversion on Blip is approximately ₹500 equivalent. At current rates, this is typically less than 1 SOL. There is no maximum limit — Blip's merchant matching engine can connect you with high-liquidity merchants for large SOL to INR conversions. The live converter above lets you check exact amounts before initiating a trade.",
  },
  {
    q: "How does Indian crypto tax work for SOL to INR conversions?",
    a: "In India, profits from selling SOL are taxed at a flat 30% (plus 4% cess) under Section 115BBH. A 1% TDS is deducted at source on crypto transfers exceeding ₹10,000 per year. You cannot offset crypto losses against other income, and losses from one crypto cannot be set off against gains from another. It is recommended to maintain detailed records of all SOL to INR conversions for tax filing purposes.",
  },
];
...
function PriceChart({
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="solInrChartFill" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor={color} stopOpacity="0.12" />
          <stop offset="100%" stopColor={color} stopOpacity="0" />
        </linearGradient>
      </defs>
      <polygon points={fillPoints} fill="url(#solInrChartFill)" />
      <polyline
        points={points}
        fill="none"
        stroke={color}
...
function buildSchemas(rate: RateData) {
  ...
  const financialServiceSchema = {
    ...
    offers: {
      "@type": "Offer",
      description: "SOL to INR conversion",
  ...
  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to Convert Solana to INR",
    description:
      "Step-by-step guide to convert Solana (SOL) to Indian Rupees using Blip Money's native Solana escrow-protected settlement protocol.",
    totalTime: "PT10M",
...
export default function SolToInr() {
    ...
    <>
      ...
      <div className="min-h-screen bg-[#FAF8F5] dark:bg-transparent">
          ...
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-black/50 dark:text-white/40 max-w-xl leading-relaxed mb-10">
                Convert SOL to Indian Rupees natively on Solana. Fastest settlement, lowest fees, escrow-protected.
              </p>
              ...
              <div className="bg-white/80 dark:bg-white/[0.04] backdrop-blur-xl border border-black/[0.08] dark:border-white/[0.06] rounded-2xl p-6 sm:p-8 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.08)] dark:shadow-none">
                  ...
                  <div className="space-y-2 mb-6 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-black/60 dark:text-white/40">
                        {conversion.fee.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} INR
                      </span>
                    </div>
                    <div className="flex justify-between">
                ...
                >
                  <span className="relative z-10">Convert SOL to INR</span>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-black/40 dark:text-white/35 mt-1">
                  Historical Solana to INR exchange rate
                </p>
              </div>
                  ...
                  {[
                    ...
                    <div key={stat.label} className="text-center">
                      ...
                      <span className="block text-sm font-bold text-black dark:text-white tabular-nums mt-1">
                        {stat.value.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} INR
                      </span>
                    </div>
                  ))}
                </div>
          ...
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            ...
            <div className="bg-white/60 dark:bg-white/[0.03] border border-black/[0.06] dark:border-white/[0.06] rounded-2xl p-6 sm:p-8">
              ...
              <p className="text-[15px] text-black/50 dark:text-white/40 leading-relaxed">
                Blip is built natively on Solana, which means SOL to INR conversions benefit from the fastest escrow settlement, the lowest network fees, and zero bridging delays. For SOL holders in India, Blip provides the most direct path from SOL to INR — your tokens never leave the Solana network during the entire conversion process.
              </p>
            </div>
          </div>
        </Section>
              ...
              <div className="flex flex-col sm:flex-row sm:items-end gap-4 mb-6">
                <div>
                  ...
                  <div className="text-3xl sm:text-4xl font-bold text-black dark:text-white tabular-nums mt-1">
                    {rate.inr.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} INR
                  </div>
                </div>
                <div className={`flex items-center gap-1 text-sm font-semibold ${(rate.inr_24h_change ?? 0) >= 0 ? "text-[#cc785c]" : "text-red-400"}`}>
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-black dark:text-white mb-2">
              Solana to INR Conversion Table
            </h2>
            <p className="text-black/40 dark:text-white/35 mb-8">
              Quick reference for common SOL to INR amounts at the current live rate.
            </p>
                  ...
                  {CONVERSION_TABLE.map((row) => (
                    <tr key={row.amount} className="border-b border-black/[0.04] dark:border-white/[0.04] last:border-0 hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="px-6 py-4 text-right font-semibold text-black dark:text-white tabular-nums">
                        {(row.amount * rate.inr).toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} INR
                      </td>
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-black dark:text-white mb-8">
              Popular SOL to INR Conversions
            </h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {POPULAR_AMOUNTS.map((item) => (
                <Link
                  key={item.crypto}
                  to={`/sol-to-inr?amount=${item.crypto}`}
                ...
                >
                  ...
                  <span className="block text-lg font-bold text-black dark:text-white mt-1 tabular-nums">
                    {(item.crypto * rate.inr).toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} INR
                  </span>
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-black dark:text-white mb-2">
              How to Convert Solana to INR
            </h2>
            <p className="text-black/40 dark:text-white/35 mb-10">
              Convert SOL to Indian Rupees in 4 simple steps — natively on Solana, no bridging required.
            </p>
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-black dark:text-white mb-10">
              Why Blip is the Best Way to Convert SOL to INR
            </h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { icon: Shield, title: "5-10 Min Settlement", desc: "SOL's sub-second finality means escrow locks instantly. Average SOL to INR settlement is under 10 minutes." },
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-black dark:text-white mb-2">
              Solana to INR — Frequently Asked Questions
            </h2>
            <p className="text-black/40 dark:text-white/35 mb-8">
              Everything you need to know about converting Solana to Indian Rupees.
            </p>
        ...
        <Section className="py-16 sm:py-20 border-t border-black/[0.04] dark:border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-4 sm:px-6 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-black dark:text-white mb-4">
              Ready to Convert Solana to INR?
            </h2>
            <p className="text-lg text-black/40 dark:text-white/35 max-w-lg mx-auto mb-8">
              Join thousands converting SOL to INR on the fastest, most native settlement protocol in India.
            </p>
            <Link
              to="https://app.blip.money/waitlist/user"
              onClick={() => sounds.click()}
          ...
          <div className="max-w-[900px] mx-auto px-4 sm:px-6 py-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { label: "SOL to AED", href: "/sol-to-aed", desc: "SOL/AED converter" },
              ].map((link) => (
                <Link
                  key={link.href}
                  to={link.href}
