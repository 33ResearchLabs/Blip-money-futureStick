...
const COMPARE_ROWS: CompareRow[] = [
  ...
  { feature: "Pricing", blip: { value: "Best rate, guaranteed", good: true }, binance: { value: "+0.14% spread", good: false }, paxful: { value: "+0.35% spread", good: false }, direct: { value: "+0.50% typical", good: false } },
