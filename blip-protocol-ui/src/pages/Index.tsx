...
const PhoneMockup = () => (
  <div className="relative
      w-[240px] h-[480px]           /* base (mobile) */
      sm:w-[280px] sm:h-[560px]     /* tablet */
      lg:w-[340px] lg:h-[680px]     /* desktop – big hero size */
      bg-[#050505]
      rounded-[2.5rem]
      border-[1px] border-[#222]
      shadow-2xl
      overflow-hidden
      z-10
      hover:scale-[1.02]
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center relative z-10">
      <div className="text-center lg:text-left pt-6 sm:pt-8 lg:pt-0">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-4xl md:text-7xl lg:text-6xl xl:text-7xl
 font-bold text-white leading-[0.95] mb-6 sm:mb-8 tracking-tight">
            Pay with Crypto
            <br />
            Anyone,
            <br />
