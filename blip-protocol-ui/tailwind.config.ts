  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "3xl": [
          "1.875rem",
          { lineHeight: "2.25rem", letterSpacing: "-0.011em" },
        ],
      ...
      boxShadow: {
        ...
        "neon-lg":
          "0 0 30px rgba(0, 255, 148, 0.5), 0 0 60px rgba(0, 255, 148, 0.3)",
        ...
        "card-hover":
          "0 25px 50px -12px rgba(0, 0, 0, 0.8), 0 0 60px rgba(0, 255, 148, 0.15)",
        glass:
      ...
      backgroundImage: {
        ...
        "gradient-primary":
          "linear-gradient(135deg, #00FF94 0%, #00D4FF 50%, #A855F7 100%)",
        "gradient-dark": "linear-gradient(180deg, #0a0a0a 0%, #000000 100%)",
        "gradient-glow":
          "radial-gradient(ellipse at center, rgba(0, 255, 148, 0.15) 0%, transparent 70%)",
        aurora:
          "radial-gradient(ellipse 80% 50% at 20% 20%, rgba(0, 255, 148, 0.1) 0%, transparent 50%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(0, 212, 255, 0.1) 0%, transparent 50%)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "reveal-scale":
          "reveal-scale 0.6s cubic-bezier(0.19, 1, 0.22, 1) forwards",
