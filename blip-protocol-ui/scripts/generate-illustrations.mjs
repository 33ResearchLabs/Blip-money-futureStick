...
const SCENES = [
  ...
  // Refer-friends hero — elegant single-subject 3D scene for merchant dashboard
  {
    file: "refer-friends-hero.png",
    prompt: `A premium 3D product render, 1:1 square, soft cinematic studio shot with a calm cream backdrop (#FAF8F5) lit from the upper-left by warm soft window light. ONE focal element only, centered: two glossy 3D interlocking rings/circles in 3/4 perspective — one in warm Claude-orange #cc785c (matte metallic finish, subtle satin highlights), the other in soft ink-charcoal — gently linked through each other like a chain link, suggesting connection between two parties. Floating just above the rings, a tiny golden spark with a thin warm-orange light trail arcing toward the link. Below the rings, a very soft drop shadow on the cream surface. The whole composition feels expensive, restrained, calm — like a piece of jewelry photographed for an Apple keynote. Generous breathing room (~15%). Restrained palette: cream + warm Claude-orange #cc785c + ink charcoal only, no other colors. No characters, no faces, no hands, no painterly brushwork, no readable text, no logos, no neon, no glow, no busy details. Apple / Linear / Stripe product-photography lineage.`,
  },
