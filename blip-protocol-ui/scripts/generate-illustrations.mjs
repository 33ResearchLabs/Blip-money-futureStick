...
const SCENES = [
  ...
  // Refer-friends hero — premium fintech referral graphic for merchant dashboard
  {
    file: "refer-friends-hero.png",
    prompt: `A premium fintech product illustration, 16:10 landscape, in the visual language of Apple Pay, Linear, and Stripe marketing imagery. Composition: a central translucent glass coin/token slightly tilted in 3/4 perspective; from it, three thin glowing warm-orange arcs branch outward to three smaller satellite tokens arranged in a gentle fan. Each arc has a tiny "+" spark mid-arc suggesting points being awarded. The whole composition reads visually as a referral chain — one source spawning rewards out to a network. Soft cinematic studio light from the upper-left, gentle iridescent reflections on the glass, very subtle warm Claude-orange #cc785c spec highlights. Background: calm cream off-white (#FAF8F5) with a soft radial gradient. Restrained, premium, uncrowded composition, ~15% breathing room. No characters, no faces, no hands, no painterly brushwork, no cartoon style, no readable text, no logos, no neon, no rainbow colors. Photoreal 3D with a soft minimal aesthetic.`,
  },
